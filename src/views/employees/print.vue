        ...
        <div class="app-container">
            <el-card>
                ...
                <div v-if="type === 'personal'">
                    ...
                    <table cellspacing="0" width="100%" class="tableList">
                        ...
                        <tr>
                            ...
                            <td rowspan="5" style="width:10%"><img style="width:155px;height:218px"
                                    :src="formData.staffPhoto"></td>
                ...
                <el-row type="flex" justify="center">
                    <el-button v-print="printObj" size="middle" type="primary">打印</el-button>
                </el-row>
            </el-card>
        </div>
    </div>
...
export default {
    data() {
        return {
            printObj: {
                id: 'myPrint'  // 按id选择器来选择打印范围，id为div标签的id选择器
            },
            formData: {},
