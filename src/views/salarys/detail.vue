...
<script>
import { getSalaryDetail, getSettings } from '@/api/constant/salarys'
import { getUserDetailById } from '@/api/user'
import { getHistorysData } from '@/api/constant/social'
import { getAtteArchiveDetail } from '@/api/constant/attendances'
